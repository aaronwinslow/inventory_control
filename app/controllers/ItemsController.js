...
.controller('ItemsController',
    ['$scope', '$q', '$location', '$routeParams', 'ItemServices', 'AuthServices', 'filterFilter',      //add services names in single quotes
function ($scope, $q, $location, $routeParams, ItemServices, AuthServices, filterFilter) {    //add service names as params
  ...
  =================================================================*/
    ...
    vm.pageSearchFields = ['itemName']; //['name', 'branch', 'category'];   //['property1', 'property2', 'property3'];
